...
You are building the definitive beginner user guide for AgentLab — a continuous optimization platform for AI agents.
...
- `docs/AGENTLAB_USER_GUIDE.md`, `docs/app-guide.md`, `docs/cli-reference.md`
...
### Required chapters:
1. **Welcome** — What is AgentLab, who is this for, what you'll learn
...
- Assume developer audience, no prior AgentLab experience
